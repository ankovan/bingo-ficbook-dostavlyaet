const statements = [
  ...
  "Гг богат(а)/популярна", "Пробелы перед знаками препинания",
  ...
  "Углубить поцелуй", "ИНГЛИШ", "Запятые не нужны", "Боксеры", "Первый раз",
  "Мой первый фф, не судите строго", "Описание персонажей вначале", "Диалоги вида: первая буква имени и двоеточие", "Попытка в графоманию (провальная)", "Худи и/или оверсайз",
  "*Мысли* (в звездочках)", "Клиффхэнгеры", "Попаданец", "ТРОЯ", "Фанфик для Роскомнадзора", "Течка"
]
let cells;
let bingoState;
let HEIGHT = 5;
