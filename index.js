const statements = [
  "Омегаверс", "Красный, как помидор", "Эвфемизмы", "Секс", "Флешбеки", "Кроссовер", "Избранный", 
  ...
  "ГГ популярен(а)", "Физика сломалась", "Редкие запятые",
  "... часть", "Мой первый фф, не судите строго", "Описание персонажей вначале", "Диалоги = Первая буква имени + «—/:»", "Графоманство", "Худи и/или оверсайз",
  "*Мысли* (в звездочках)", "Клиффхэнгеры", "Попаданец", "ТРОЯ", "Суицидальные штучки"
]
let cells;
let bingoState;
let HEIGHT = 5;
